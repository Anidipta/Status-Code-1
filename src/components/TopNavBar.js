...
import { AppBar, Toolbar, Typography, IconButton, Drawer, List, ListItem, ListItemIcon, ListItemText, Button, Badge, Menu, MenuItem } from '@mui/material';
...
const TopNavBar = () => {
  ...
  useEffect(() => {
    ...
    if (path.includes('/health-records')) {
      ...
      setActiveMenu('Appointments'); // Default to 'Appointments'
    }
  }, [location]);
    ...
    <AppBar position="fixed" style={{ backgroundColor: '#1e3a8a' }}>
      <Toolbar>
        ...
        >
          <a href="/" style={{ display: 'flex', alignItems: 'center', textDecoration: 'none', color: 'inherit' }}>
            ...
            <span style={{ color: '#228B22', fontWeight: 'bold' }}>Medi</span>
            <span style={{ color: '#000', fontWeight: 'bold' }}>Track</span>
          </a>
        </Typography>
      ...
      >
        <MenuItem onClick={handleNotificationClose}>
          <Typography variant="body1">Booked Appointment for 25 Aug</Typography>
        </MenuItem>
      </Menu>
    </AppBar>
  );
